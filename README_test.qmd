...
In August, we deployed 25 Wildlife Acoustics Song Meter Micro units across Lithuania to initiate continuous, year-long monitoring aimed at capturing year-round seasonal avian activity and filling key temporal data gaps from our previous field season. The deployment encompassed 12 sites in Žuvintas Biosphere Reserve, 12 sites in Curonian Spit National Park, and one reference unit in Vilnius. To ensure uninterrupted recording across this extended schedule, we provided local collaborators with additional battery sets and memory cards to complete a mid-term hardware inspection and data swap late in the year.
...
A total of 36 units were deployed in early May and retrieved at the end of July, yielding a three-month monitoring window during the peak breeding season. An intensive 24-hour recording schedule was maintained across all units throughout this period to meet hardware return deadlines from partner institutions.

1.  AudioMoth (24 units): Half of the units (12) were borrowed from National Geographics and another half were borrowed from University of Northern British Columbia (UNBC).
...
2.  SongMini (10 units): Borrowed from Birds Canada (from David Bradley). All retrieved after 3 months of monitoring and returned.
...
![alt text](WhatsApp%20Image%202025-04-17%20at%2016.14.43_ac44281a.jpg) \#### Before field (AudioMoth) 1. Insert 3 Energizer batteries and a microSD card into the unit. 2. Secure the unit with an elastic band, taking care not to cover: - The white switch - The SD card slot - The microphone 3. Place the unit into a plastic bag with two desiccant packs, positioning the microphone at the bottom of the bag. 4. Use duct tape to create a loop at the top of the bag for mounting.
